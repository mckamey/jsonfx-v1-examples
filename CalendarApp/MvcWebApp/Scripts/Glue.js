...
JsonFx.IO.onFailure = function(/*XMLHttpRequest*/ xhr, /*context*/ cx, /*Error*/ ex) {
	...
	Calendar.Alert.show("Sorry an error occurred...", msg, null);
};

/* Browser TimeZone --------------------------------------------------------- */

// ensure the server always knows the user's timezone
